"use client";
// Fixed: the local "draft" state wasn't syncing when the parent's
// committed filters changed from outside this component (e.g. after
    ...
    <div className="bg-white rounded-2xl border border-[#E8E8E8] shadow-sm px-4 py-3 flex flex-wrap items-center gap-2.5">
      <div className="relative flex-1 min-w-[180px]">
        ...
        <input
          ...
          className="w-full rounded-lg border border-[#E8E8E8] bg-[#F8F9FC] pl-9 pr-3 py-2 text-sm text-zinc-700 focus:outline-none focus:ring-2 focus:ring-[#FF5F9E]/40"
        />
      </div>
      ...
      <select
        ...
        className="rounded-lg border border-[#E8E8E8] bg-[#F8F9FC] px-3 py-2 text-sm text-zinc-700 focus:outline-none focus:ring-2 focus:ring-[#FF5F9E]/40"
      >
      ...
      <select
        value={draft.status}
        onChange={(e) => setDraft({ ...draft, status: e.target.value as FilterState["status"] })}
        className="rounded-lg border border-[#E8E8E8] bg-[#F8F9FC] px-3 py-2 text-sm text-zinc-700 focus:outline-none focus:ring-2 focus:ring-[#FF5F9E]/40"
      >
      ...
      <button type="button" onClick={() => onApply(draft)} className="bg-[#FF5F9E] hover:bg-[#e0538c] text-white font-semibold text-sm px-5 py-2 rounded-lg transition-colors">
        Apply
      </button>
      <button type="button" onClick={onReset} className="border border-[#E8E8E8] text-zinc-600 font-medium text-sm px-4 py-2 rounded-lg hover:bg-zinc-50 transition-colors">
        Reset
      </button>
