...
const exportColumns: ExportColumn<TransactionReportRow>[] = [
  { header: "Transaction ID", accessor: (r) => r.id },
  { header: "Pet", accessor: (r) => r.petName },
...
export default function TransactionFilterToolbar({
  ...
  return (
    <div className="bg-white rounded-2xl border border-[#E8E8E8] shadow-sm px-4 py-3 flex flex-wrap items-center gap-2.5">
      ...
      <ExportMenu title="Transaction Reports" columns={exportColumns} rows={rows} filename="transaction-reports" />
    </div>
  );
}
